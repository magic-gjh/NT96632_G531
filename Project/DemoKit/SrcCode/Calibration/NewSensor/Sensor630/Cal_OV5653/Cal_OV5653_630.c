...
void CAL_PassAdjustData(void)
{
    ...
    {//DP
        ...
        Prv_DP[0] = AAA_Adjust.DP_Cap_Num[2];
...
//////////////////////////////////////////////////////////////////
        ...
        Photo_LockAWB(LOCK);
        wai_flg(&uiFlag1, FLG_ID_PHOTO, FLGPHOTO_2NDIDLE, TWF_ORW);
        AeSetPrvExpoLine(MaxExpLine_1280x480);
        AeSetAGCGainISO(400);
        RawAddr = ippbuf_GetBuf(IPPBUF_PRV_END);
        CalPreviewOne(  RawAddr,
                        _SieBitDepth_8,
...
///////////////////////////////////////////////////////////////////////////
        ...
        Photo_SetImageResolution(_Resolution_1280x720, IPL_MODE_PREVIEW);
        Photo_LockAE(LOCK);
        Photo_LockAWB(LOCK);
        wai_flg(&uiFlag1, FLG_ID_PHOTO, FLGPHOTO_2NDIDLE, TWF_ORW);
        AeSetPrvExpoLine(MaxExpLine_1280x720);
        AeSetAGCGainISO(400);
        RawAddr = ippbuf_GetBuf(IPPBUF_PRV_END);
        CalPreviewOne(  RawAddr,
                        _SieBitDepth_8,
        ...
        //Cal_AlgShowString("PRV DARK...1sec", 20, 100);
        DP_Cnt_PD1 = DFP_Bayer_Search(
                    RawAddr+(CalInfor.SkipPrv2.SkipYU*PrvRawHSize+CalInfor.SkipPrv2.SkipXL),
                    PrvRawHSize-CalInfor.SkipPrv2.SkipXL-CalInfor.SkipPrv2.SkipXR,
                    PrvRawVSize-CalInfor.SkipPrv2.SkipYU-CalInfor.SkipPrv2.SkipYD,
                    PrvRawHSize, //HSize = Line-offset
                    (UW)(AAA_Adjust.Defect_Pixel) + DP_Prv_MAX<<2,
                    0/*no-crop-offset*/+CalInfor.SkipPrv2.SkipXL,
                    0/*no-crop-offset*/+CalInfor.SkipPrv2.SkipYU,
                    0,
                    DP_Prv_MAX,
                    CalInfor.DarkLimitPrv,
                    CalInfor.BlockPrv.Block_X,
...
////////////////////////////////////////////////////////////////////////////
        ...
        //Cal_AlgShowString("PRV DARK...1sec", 20, 100);
        DP_Cnt_PD2 = DFP_Bayer_Search(
                    RawAddr+(CalInfor.SkipPrv3.SkipYU*PrvRawHSize+CalInfor.SkipPrv3.SkipXL),
                    PrvRawHSize-CalInfor.SkipPrv3.SkipXL-CalInfor.SkipPrv3.SkipXR,
                    PrvRawVSize-CalInfor.SkipPrv3.SkipYU-CalInfor.SkipPrv3.SkipYD,
                    PrvRawHSize, //HSize = Line-offset
                    (UW)(AAA_Adjust.Defect_Pixel) ,//+ (DP_Prv_MAX + DP_Prv_MAX_2)<<2,
                    0/*no-crop-offset*/+CalInfor.SkipPrv3.SkipXL,
                    0/*no-crop-offset*/+CalInfor.SkipPrv3.SkipYU,
                    0,
                    DP_Prv_MAX,
                    CalInfor.DarkLimitPrv,
                    CalInfor.BlockPrv.Block_X,
...
///////////////////////////////////////////////////////////////////////////////
        ...
        sprintf(message, "%d", DP_Cnt_PW+DP_Cnt_PD+DP_Cnt_PD1+DP_Cnt_PD2);
        Cal_AlgShowString(message, Cal_PanelMsgXPos(2),Cal_PanelMsgYPos(2));
        if((DP_Cnt_PW+DP_Cnt_PD+DP_Cnt_PD1+DP_Cnt_PD2) >= (DP_Prv_MAX))//+DP_Prv_MAX_2+DP_Prv_MAX_3))
        {
    ...
    FST_TIME_INFINITE);//FST_TIME_NO_WAIT);
        ...
        DP_Cnt_CD = DFP_Bayer_Search(
                    ...
                    CapRawVSize-CalInfor.SkipCap.SkipYU-CalInfor.SkipCap.SkipYD,
                    CapRawHSize,
                    (UW)(AAA_Adjust.Defect_Pixel)+((DP_Prv_MAX<<2)),//+DP_Prv_MAX_2+DP_Prv_MAX_3)<<2),
                    pre_GetCropHIni()+CalInfor.SkipCap.SkipXL,
                    pre_GetCropVIni()*SensorCapTotalFld+CalInfor.SkipCap.SkipYU,
                    DP_Cnt_CW,
                    DP_Prv_MAX,//+DP_Prv_MAX_2+DP_Prv_MAX_3,
    ...
    //summary
    DP_Cnt_Prv = DP_Cnt_PW+DP_Cnt_PD+DP_Cnt_PD1+DP_Cnt_PD2;
    DP_Cnt_Cap = DP_Cnt_CW+DP_Cnt_CD;
    AAA_Adjust.DP_Cap_Num[0] = 0;//DP_Cnt_PW;
    AAA_Adjust.DP_Cap_Num[1] = 0;//DP_Cnt_CW;
    AAA_Adjust.DP_Cap_Num[2] = DP_Cnt_PD;
    AAA_Adjust.DP_Cap_Num[3] = DP_Cnt_PD1;
    AAA_Adjust.DP_Cap_Num[4] = DP_Cnt_PD2;
    AAA_Adjust.DP_Cap_Num[5] = DP_Cnt_CD;
    debug_err(("Cal_DP_DARK: DFP White = %d, %d\r\n\r\n", DP_Cnt_PW, DP_Cnt_CW));
    debug_err(("Cal_DP_DARK: DFP Dark = %d %d %d, %d\r\n\r\n", DP_Cnt_PD,DP_Cnt_PD1,DP_Cnt_PD2, DP_Cnt_CD));
    debug_err(("ErrorCode = %d, DP Num Prv = %d, Cap = %d\r\n", ErrorCode, DP_Cnt_Prv, DP_Cnt_Cap));
    ...
    if(ErrorCode==0)
    {
        ...
        SortDPdata((UW*)&AAA_Adjust.Defect_Pixel[DP_Prv_MAX/*+DP_Prv_MAX_2+DP_Prv_MAX_3*/],    DP_Cnt_Cap);

        SortDPdata2Fld((UW*)&AAA_Adjust.Defect_Pixel[DP_Prv_MAX/*+DP_Prv_MAX_2+DP_Prv_MAX_3*/],    DP_Cnt_Cap);

        AAA_Adjust.Defect_Pixel[DP_Cnt_Prv] = 0xFFFFFFFF;
        AAA_Adjust.Defect_Pixel[DP_Prv_MAX/*+DP_Prv_MAX_2+DP_Prv_MAX_3*/+DP_Cnt_Cap+SensorCapTotalFld-1] = 0xFFFFFFFF;
