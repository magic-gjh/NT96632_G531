...
//TK CMOS SENSOR PWR1
#define GPIO_CMOS_PWR1                D_GPIO_0//14//#Linfg@0915#for dv121na

//TK CMOS SENSOR PWR2
#define GPIO_CMOS_PWR2                D_GPIO_1//14//#Linfg@0915#for dv121na
...
#define GPIO_LCD_RESET              47//(2| GPIO_IS_DGPIO)
...
#define GPIO_PWM_BLG_PCTL           (P_GPIO_31)//D_GPIO_5
...
#define GPIO_CCD_PCTL               48//(11 | GPIO_IS_DGPIO)
#define PAD_CCD_PCTL                PAD_PIN_MC48//PAD_PIN_DGPIO11
...
#define GPIO_KEY_SHUTTER            C_GPIO_17//(9 | GPIO_IS_DGPIO)
#define PAD_KEY_SHUTTER             PAD_PIN_MC17//PAD_PIN_DGPIO9

// LED
#define GPIO_LED_R                  62//no use
#define GPIO_LED_G                  62//no use
#define GPIO_LED_FCS                62//(0 | GPIO_IS_DGPIO)//62//no use//#Linfg@0915#for dv121na
