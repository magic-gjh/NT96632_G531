...
//Channel  1
#define KEY_ADC_LEVEL_1         0
#define KEY_ADC_LEVEL_2         244//265
#define KEY_ADC_LEVEL_3         536
#define KEY_ADC_LEVEL_4         816
...
UINT32 KeyADC_GetKey(void)
{
    ...
    if (ad2 < (KEY_ADC_LEVEL_1 + ADC_ERR))
    {
        key2 = FLGKEY_MODE;
        //debug_err(("KEY MODE\r\n"));
    }
    else if ((ad2 > (KEY_ADC_LEVEL_2 - ADC_ERR)) && (ad2 < (KEY_ADC_LEVEL_2 + ADC_ERR)))
    {
        key2 = FLGKEY_UP;
        //debug_err(("KEY UP\r\n"));
    }
...
void KeyADC_Init(void)
{
    ...
    adc_setChDivider(KEY_ADC_CH_2, 18);
