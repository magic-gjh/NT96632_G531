...
// Timer
extern UINT32   KeyScan_startTimer(UINT32 interval, UINT32 eventID, TIMER_TYPE type);
...
extern UINT32  KeyScan_EnableDeLcdOff(BOOL En);

extern UINT32  KeyScan_DeLcdOff(void);

extern void  KeyScan_NAVIComunicate(void);
