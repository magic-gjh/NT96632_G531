...
#define VOLDET_BATTERY_ADC_LVL0     544     // ~3.3V    //3.45v
#define VOLDET_BATTERY_ADC_LVL1     550     // 3.5~ 3.7V
#define VOLDET_BATTERY_ADC_LVL2     570     // 3.7~ 3.9V
#define VOLDET_BATTERY_ADC_LVL3     600     // 3.9~ 4.20V
...
#if 1 //TODO: Battery detection HW ckt issue!!!
...
//   debug_err(("battery ADC = %d\r\n", uiCurBatteryADC));  // iven_tools
    ...
    if (uiCurBatteryADC > uiPreBatteryADC)
    {
        ...
        else if (uiCurBatteryADC > (batt_adc_lvl0 + VOLDET_BATTERY_ADC_TH))  //344+2
        {
