...
// Battery voltage
#if 1
#define VOLDET_BATTERY_ADC_EMPTY    723     // ~ 3.3V
#define VOLDET_BATTERY_ADC_LVL0     755     // ~ 3.55V
#define VOLDET_BATTERY_ADC_LVL1     771     // ~ 3.65V
#define VOLDET_BATTERY_ADC_LVL2     792     // ~ 3.75V
#define VOLDET_BATTERY_ADC_LVL3     812     // ~ 3.85V
#define VOLDET_BATTERY_ADC_TH       2       // 7
#else
#define VOLDET_BATTERY_ADC_EMPTY    723     // ~ 3.5V
#define VOLDET_BATTERY_ADC_LVL0     744     // ~ 3,6V
#define VOLDET_BATTERY_ADC_LVL1     785     // ~ 3,8V
#define VOLDET_BATTERY_ADC_LVL2     826     // ~ 4.0V
#define VOLDET_BATTERY_ADC_LVL3     868     // ~ 4.20V
#define VOLDET_BATTERY_ADC_TH       2       // 7
#endif
// for Alkaline
