...
// Battery voltage
/**
#define VOLDET_BATTERY_ADC_LVL0     555     // ~ 3.5V
#define VOLDET_BATTERY_ADC_LVL1     570     // ~ 3.6V
#define VOLDET_BATTERY_ADC_LVL2     600     // ~ 3.8V
#define VOLDET_BATTERY_ADC_LVL3     630     // ~ 4.0V
#define VOLDET_BATTERY_ADC_TH       2       // 7
**/
#define VOLDET_BATTERY_ADC_LVL0     570     // ~ 3.6V
#define VOLDET_BATTERY_ADC_LVL1     585     // ~ 3.7V
#define VOLDET_BATTERY_ADC_LVL2     600     // ~ 3.8V
#define VOLDET_BATTERY_ADC_LVL3     630     // ~ 4.0V
#define VOLDET_BATTERY_ADC_TH       2
