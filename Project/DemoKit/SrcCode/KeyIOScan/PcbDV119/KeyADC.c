...
#define KEY_RIGHT_ADC           810

//Channel  2
#define KEY_MODE_ADC            0
#define KEY_DELETE_ADC          245
#define KEY_ENTER_ADC           510
...
UINT32 KeyADC_GetKey(void)
{
    ...
    else if ((uiADCValue2 > (KEY_ENTER_ADC - KEY_VALUE_TH))
       && (uiADCValue2 < (KEY_ENTER_ADC + KEY_VALUE_TH)))
    {
        DEBUG_MSG(("adc2:%d\r\n",uiADCValue2));
...
UINT32 KeyADC_GetSpecialKey(void) // for DV121 special key combination detection
{
    UINT32 uiADCValue1, uiADCValue2;
