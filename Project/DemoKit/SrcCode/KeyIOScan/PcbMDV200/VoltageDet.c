...
#define VOLDET_BATTERY_ADC_LVL0     725     // ~ 3.5V
#define VOLDET_BATTERY_ADC_LVL1     745     // ~ 3.6V
#define VOLDET_BATTERY_ADC_LVL2     765     // ~ 3.7V
#define VOLDET_BATTERY_ADC_LVL3     785     // ~ 3.8V
...
UINT32 VolDet_GetBatteryLevel(void)
{
    ...
    debug_ind(("VOLDET: battery ADC = %d\r\n", uiCurBatteryADC));
