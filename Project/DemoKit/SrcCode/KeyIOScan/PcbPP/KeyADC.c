...
#define KEY_ADC1_LEVEL_1        40
#define KEY_ADC1_LEVEL_2        415

#define KEY_ADC2_LEVEL_1        30
#define KEY_ADC2_LEVEL_2        247
#define KEY_ADC2_LEVEL_3        515
#define KEY_ADC2_LEVEL_4        815
...
UINT32 KeyADC_GetKey(void)
{
    ...
    if (ad2 >= KEY_ADC2_LEVEL_1 - ADC_ERR && ad2 <= KEY_ADC2_LEVEL_1 + ADC_ERR)
        ...
        key2 = FLGKEY_PLAYBACK;
    else if (ad2 > KEY_ADC2_LEVEL_4 - ADC_ERR && ad2 < KEY_ADC2_LEVEL_4 + ADC_ERR)
        key2 = FLGKEY_MENU;
