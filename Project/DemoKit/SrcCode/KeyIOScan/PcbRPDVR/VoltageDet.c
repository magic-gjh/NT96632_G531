...
#define VOLDET_FLASH_ADC_CH         ADC_CHANNEL_4
...
*/
#define VOLDET_BATTERY_ADC_LVL0     850     // ~ 3.3V
#define VOLDET_BATTERY_ADC_LVL1     890     // ~ 3.6V
#define VOLDET_BATTERY_ADC_LVL2     940     // ~ 3.8V
#define VOLDET_BATTERY_ADC_LVL3     985     // ~ 4V
#define VOLDET_BATTERY_ADC_TH       2       // 7
...
UINT32 VolDet_GetBatteryLevel(void)
{
    ...
    return uiRetBatteryLvl;//VOLDET_BATTERY_LVL_3;// 
}
