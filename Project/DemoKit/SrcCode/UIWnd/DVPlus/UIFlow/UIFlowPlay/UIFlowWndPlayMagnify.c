...
INT32 UIFlowWndPlayMagnify_OnKeyPlayback(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_KEY_PLAYBACK,UIFlowWndPlayMagnify_OnKeyPlayback)
...
INT32 UIFlowWndPlayMagnify_OnKeyPlayback(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    Ux_CloseWindow((VControl *)(&UIFlowWndPlayMagnifyCtrl), 1, NVTRET_MAGNIFY);
    return NVTEVT_CONSUME;
}
...
static INT32 UIFlowWndPlayMagnify_DrawZoomRatio(void)
{
    ...
    snprintf(item1_Buf, 32, "x%d.%d", temp1, temp2);
