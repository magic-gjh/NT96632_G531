...
static void UIFlowWndPhoto_UpdateWndInfo(void)
{
    ...
    UxState_SetData(&UIFlowWndPhoto_StatusICN_AntiShakingCtrl,STATE_CURITEM,Get_AntiShakingIndex());
    ...
    UxCtrl_SetShow(&UIFlowWndPhoto_StatusICN_AntiShakingCtrl,TRUE);
