...
#ifndef UIMENUWNDMOVIEDISRES_H
#define UIMENUWNDMOVIEDISRES_H
...
SHOW_MAP_BEGIN(UIMenuWndMovieDIS_Menu)
...
DECLARE_EVENT(UIMenuWndMovieDIS_Menu)
MENU_LIST_BEGIN(UIMenuWndMovieDIS_Menu)
MENU_LIST_ITEM(STRID_OFF32)
MENU_LIST_ITEM(STRID_ON33)
MENU_LIST_END

CREATE_MENU_DATA(UIMenuWndMovieDIS_Menu,0,2,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_CYCLE|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_NORMAL|MENU_DRAW_IMAGE)

CREATE_MENU_CTRL(UIMenuWndMovieDIS_Menu,UIMenuWndMovieDIS_Menu,0,16,5,231,42)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndMovieDIS_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieDIS_Panel)
DECLARE_CTRL_LIST(UIMenuWndMovieDIS_Panel)
CREATE_CTRL(UIMenuWndMovieDIS_Panel,UIMenuWndMovieDIS_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
SHOW_MAP_BEGIN(UIMenuWndMovieDIS)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieDIS)
DECLARE_CTRL_LIST(UIMenuWndMovieDIS)
CREATE_CTRL(UIMenuWndMovieDIS,UIMenuWndMovieDIS,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
