...
#ifndef UIMENUWNDMOVIERESOLUTIONRES_H
#define UIMENUWNDMOVIERESOLUTIONRES_H
...
CREATE_MENU_ITEM_DATA(STRID_NULL32,STRID_NULL,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_IMGSIZE33,STRID_IMGSIZE,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_MODE34,STRID_MODE,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_RESOLUTION35,STRID_RESOLUTION,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
SHOW_MAP_BEGIN(UIMenuWndMovieRes_Menu)
...
DECLARE_EVENT(UIMenuWndMovieRes_Menu)
MENU_LIST_BEGIN(UIMenuWndMovieRes_Menu)
MENU_LIST_ITEM(STRID_NULL32)
MENU_LIST_ITEM(STRID_IMGSIZE33)
MENU_LIST_ITEM(STRID_MODE34)
MENU_LIST_ITEM(STRID_RESOLUTION35)
MENU_LIST_END

CREATE_MENU_DATA(UIMenuWndMovieRes_Menu,0,4,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_CYCLE|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_NORMAL|MENU_DRAW_IMAGE)

CREATE_MENU_CTRL(UIMenuWndMovieRes_Menu,UIMenuWndMovieRes_Menu,0,16,5,231,42)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndMovieRes_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieRes_Panel)
DECLARE_CTRL_LIST(UIMenuWndMovieRes_Panel)
CREATE_CTRL(UIMenuWndMovieRes_Panel,UIMenuWndMovieRes_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
SHOW_MAP_BEGIN(UIMenuWndMovieRes)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieRes)
DECLARE_CTRL_LIST(UIMenuWndMovieRes)
CREATE_CTRL(UIMenuWndMovieRes,UIMenuWndMovieRes,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
