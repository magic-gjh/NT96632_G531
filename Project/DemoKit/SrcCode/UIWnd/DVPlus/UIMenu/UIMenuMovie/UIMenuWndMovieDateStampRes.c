...
#ifndef UIMENUWNDMOVIEDATESTAMPRES_H
#define UIMENUWNDMOVIEDATESTAMPRES_H
...
SHOW_MAP_BEGIN(UIMenuWndMovieDateStamp_Menu)
...
DECLARE_EVENT(UIMenuWndMovieDateStamp_Menu)
MENU_LIST_BEGIN(UIMenuWndMovieDateStamp_Menu)
MENU_LIST_ITEM(STRID_OFF32)
MENU_LIST_ITEM(STRID_ON33)
MENU_LIST_END

CREATE_MENU_DATA(UIMenuWndMovieDateStamp_Menu,0,2,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_CYCLE|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_NORMAL|MENU_DRAW_IMAGE)

CREATE_MENU_CTRL(UIMenuWndMovieDateStamp_Menu,UIMenuWndMovieDateStamp_Menu,0,16,5,231,42)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndMovieDateStamp_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieDateStamp_Panel)
DECLARE_CTRL_LIST(UIMenuWndMovieDateStamp_Panel)
CREATE_CTRL(UIMenuWndMovieDateStamp_Panel,UIMenuWndMovieDateStamp_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
SHOW_MAP_BEGIN(UIMenuWndMovieDateStamp)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieDateStamp)
DECLARE_CTRL_LIST(UIMenuWndMovieDateStamp)
CREATE_CTRL(UIMenuWndMovieDateStamp,UIMenuWndMovieDateStamp,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
