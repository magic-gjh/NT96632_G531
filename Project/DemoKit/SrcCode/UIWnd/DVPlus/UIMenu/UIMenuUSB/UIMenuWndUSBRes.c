...
CREATE_MENU_ITEM_DATA(STRID_PICTBRIDGE66,STRID_PICTBRIDGE,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_PCC67,STRID_PCC,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
...
MENU_LIST_ITEM(STRID_PICTBRIDGE66)
MENU_LIST_ITEM(STRID_PCC67)
MENU_LIST_END
