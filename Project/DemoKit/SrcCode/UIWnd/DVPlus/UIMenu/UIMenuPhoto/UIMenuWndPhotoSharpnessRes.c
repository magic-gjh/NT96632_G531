...
CREATE_MENU_ITEM_DATA(STRID_STRONG32,STRID_STRONG,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_NORMAL33,STRID_NORMAL,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_SOFT34,STRID_SOFT,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
...
MENU_LIST_ITEM(STRID_STRONG32)
MENU_LIST_ITEM(STRID_NORMAL33)
MENU_LIST_ITEM(STRID_SOFT34)
MENU_LIST_END
...
CREATE_MENU_CTRL(UIMenuWndPhotoSharpness_Menu,UIMenuWndPhotoSharpness_Menu,0,23,3,226,41)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndPhotoSharpness_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndPhotoSharpness_Panel)
DECLARE_CTRL_LIST(UIMenuWndPhotoSharpness_Panel)
CREATE_CTRL(UIMenuWndPhotoSharpness_Panel,UIMenuWndPhotoSharpness_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
