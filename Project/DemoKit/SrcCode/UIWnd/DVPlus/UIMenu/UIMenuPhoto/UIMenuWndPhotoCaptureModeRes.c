...
#ifndef UIMENUWNDPHOTOCAPTUREMODERES_H
#define UIMENUWNDPHOTOCAPTUREMODERES_H
...
CREATE_MENU_ITEM_DATA(STRID_CAP_SINGLE32,STRID_CAP_SINGLE,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_CAP_TIMER2S33,STRID_CAP_TIMER2S,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_CAP_TIMER5S34,STRID_CAP_TIMER5S,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_CAP_TIMER10S35,STRID_CAP_TIMER10S,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_CAP_BURST36,STRID_CAP_BURST,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
SHOW_MAP_BEGIN(UIMenuWndPhotoCaptureMode_Menu)
...
DECLARE_EVENT(UIMenuWndPhotoCaptureMode_Menu)
MENU_LIST_BEGIN(UIMenuWndPhotoCaptureMode_Menu)
MENU_LIST_ITEM(STRID_CAP_SINGLE32)
MENU_LIST_ITEM(STRID_CAP_TIMER2S33)
MENU_LIST_ITEM(STRID_CAP_TIMER5S34)
MENU_LIST_ITEM(STRID_CAP_TIMER10S35)
MENU_LIST_ITEM(STRID_CAP_BURST36)
MENU_LIST_END

CREATE_MENU_DATA(UIMenuWndPhotoCaptureMode_Menu,0,4,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_CYCLE|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_NORMAL|MENU_DRAW_IMAGE)

CREATE_MENU_CTRL(UIMenuWndPhotoCaptureMode_Menu,UIMenuWndPhotoCaptureMode_Menu,0,23,3,226,41)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndPhotoCaptureMode_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndPhotoCaptureMode_Panel)
DECLARE_CTRL_LIST(UIMenuWndPhotoCaptureMode_Panel)
CREATE_CTRL(UIMenuWndPhotoCaptureMode_Panel,UIMenuWndPhotoCaptureMode_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
SHOW_MAP_BEGIN(UIMenuWndPhotoCaptureMode)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndPhotoCaptureMode)
DECLARE_CTRL_LIST(UIMenuWndPhotoCaptureMode)
CREATE_CTRL(UIMenuWndPhotoCaptureMode,UIMenuWndPhotoCaptureMode,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
