...
#ifndef UIMENUWNDPHOTOFDRES_H
#define UIMENUWNDPHOTOFDRES_H
...
CREATE_MENU_ITEM_DATA(STRID_FACE_DET33,STRID_FACE_DET,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_SMILE_DET34,STRID_SMILE_DET,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
SHOW_MAP_BEGIN(UIMenuWndPhotoFD_Menu)
...
DECLARE_EVENT(UIMenuWndPhotoFD_Menu)
MENU_LIST_BEGIN(UIMenuWndPhotoFD_Menu)
MENU_LIST_ITEM(STRID_OFF32)
MENU_LIST_ITEM(STRID_FACE_DET33)
MENU_LIST_ITEM(STRID_SMILE_DET34)
MENU_LIST_END

CREATE_MENU_DATA(UIMenuWndPhotoFD_Menu,0,3,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_CYCLE|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_NORMAL|MENU_DRAW_IMAGE)

CREATE_MENU_CTRL(UIMenuWndPhotoFD_Menu,UIMenuWndPhotoFD_Menu,0,23,3,226,41)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndPhotoFD_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndPhotoFD_Panel)
DECLARE_CTRL_LIST(UIMenuWndPhotoFD_Panel)
CREATE_CTRL(UIMenuWndPhotoFD_Panel,UIMenuWndPhotoFD_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
SHOW_MAP_BEGIN(UIMenuWndPhotoFD)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndPhotoFD)
DECLARE_CTRL_LIST(UIMenuWndPhotoFD)
CREATE_CTRL(UIMenuWndPhotoFD,UIMenuWndPhotoFD,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
