...
CREATE_MENU_ITEM_DATA(STRID_SUPER32,STRID_SUPER,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_FINE33,STRID_FINE,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_NORMAL34,STRID_NORMAL,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
...
MENU_LIST_ITEM(STRID_SUPER32)
MENU_LIST_ITEM(STRID_FINE33)
MENU_LIST_ITEM(STRID_NORMAL34)
MENU_LIST_END
...
CREATE_MENU_CTRL(UIMenuWndPhotoCompression_Menu,UIMenuWndPhotoCompression_Menu,0,23,3,226,41)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndPhotoCompression_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndPhotoCompression_Panel)
DECLARE_CTRL_LIST(UIMenuWndPhotoCompression_Panel)
CREATE_CTRL(UIMenuWndPhotoCompression_Panel,UIMenuWndPhotoCompression_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
