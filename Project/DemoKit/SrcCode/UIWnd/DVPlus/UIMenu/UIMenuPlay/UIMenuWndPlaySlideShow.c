...
INT32 UIMenuWndPlaySlideShow_Menu_OnKeyMenu(VControl *, UINT32, UINT32 *);
INT32 UIMenuWndPlaySlideShow_Menu_OnKeyLeft(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_KEY_MENU,UIMenuWndPlaySlideShow_Menu_OnKeyMenu)
EVENT_ITEM(NVTEVT_KEY_LEFT,UIMenuWndPlaySlideShow_Menu_OnKeyLeft)
EVENT_END
...
INT32 UIMenuWndPlaySlideShow_Menu_OnKeyMenu(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
...
INT32 UIMenuWndPlaySlideShow_Menu_OnKeyLeft(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    //#NT#2009/08/03#Chris Chung -begin
