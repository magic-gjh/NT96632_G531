...
CREATE_MENU_ITEM_DATA(STRID_DATE33,STRID_DATE,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_DATE_TIME34,STRID_DATE_TIME,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
...
MENU_LIST_ITEM(STRID_DATE33)
MENU_LIST_ITEM(STRID_DATE_TIME34)
MENU_LIST_END
...
CREATE_MENU_CTRL(UIMenuWndPhotoDateStamp_Menu,UIMenuWndPhotoDateStamp_Menu,0,23,3,226,41)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndPhotoDateStamp_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndPhotoDateStamp_Panel)
DECLARE_CTRL_LIST(UIMenuWndPhotoDateStamp_Panel)
CREATE_CTRL(UIMenuWndPhotoDateStamp_Panel,UIMenuWndPhotoDateStamp_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
