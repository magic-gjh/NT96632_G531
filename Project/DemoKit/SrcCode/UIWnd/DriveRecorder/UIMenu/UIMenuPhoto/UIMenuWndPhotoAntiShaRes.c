...
#ifndef UIMENUWNDPHOTOANTISHARES_H
#define UIMENUWNDPHOTOANTISHARES_H
...
CREATE_MENU_ITEM_DATA(STRID_ON33,STRID_ON,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
SHOW_MAP_BEGIN(UIMenuWndPhotoAntiSha_Menu)
...
DECLARE_EVENT(UIMenuWndPhotoAntiSha_Menu)
MENU_LIST_BEGIN(UIMenuWndPhotoAntiSha_Menu)
MENU_LIST_ITEM(STRID_OFF32)
MENU_LIST_ITEM(STRID_ON33)
MENU_LIST_END

CREATE_MENU_DATA(UIMenuWndPhotoAntiSha_Menu,0,2,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_CYCLE|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_NORMAL|MENU_DRAW_IMAGE)

CREATE_MENU_CTRL(UIMenuWndPhotoAntiSha_Menu,UIMenuWndPhotoAntiSha_Menu,0,23,3,226,41)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndPhotoAntiSha_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndPhotoAntiSha_Panel)
DECLARE_CTRL_LIST(UIMenuWndPhotoAntiSha_Panel)
CREATE_CTRL(UIMenuWndPhotoAntiSha_Panel,UIMenuWndPhotoAntiSha_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
SHOW_MAP_BEGIN(UIMenuWndPhotoAntiSha)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndPhotoAntiSha)
DECLARE_CTRL_LIST(UIMenuWndPhotoAntiSha)
CREATE_CTRL(UIMenuWndPhotoAntiSha,UIMenuWndPhotoAntiSha,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
