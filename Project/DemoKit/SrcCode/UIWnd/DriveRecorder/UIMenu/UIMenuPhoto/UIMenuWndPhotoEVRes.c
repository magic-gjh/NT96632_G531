...
#ifndef UIMENUWNDPHOTOEVRES_H
#define UIMENUWNDPHOTOEVRES_H
...
SHOW_MAP_BEGIN(UIMenuWndPhotoEV_Menu)
...
DECLARE_EVENT(UIMenuWndPhotoEV_Menu)
MENU_LIST_BEGIN(UIMenuWndPhotoEV_Menu)
...
CREATE_MENU_DATA(UIMenuWndPhotoEV_Menu,0,4,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_CYCLE|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_NORMAL|MENU_DRAW_IMAGE)

CREATE_MENU_CTRL(UIMenuWndPhotoEV_Menu,UIMenuWndPhotoEV_Menu,0,23,3,226,41)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndPhotoEV_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndPhotoEV_Panel)
DECLARE_CTRL_LIST(UIMenuWndPhotoEV_Panel)
CREATE_CTRL(UIMenuWndPhotoEV_Panel,UIMenuWndPhotoEV_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
SHOW_MAP_BEGIN(UIMenuWndPhotoEV)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndPhotoEV)
DECLARE_CTRL_LIST(UIMenuWndPhotoEV)
CREATE_CTRL(UIMenuWndPhotoEV,UIMenuWndPhotoEV,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
