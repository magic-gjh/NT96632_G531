...
#ifndef UIMENUWNDPHOTOQUICKVIEWRES_H
#define UIMENUWNDPHOTOQUICKVIEWRES_H
...
CREATE_MENU_ITEM_DATA(STRID_2SEC33,STRID_2SEC,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_5SEC34,STRID_5SEC,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
SHOW_MAP_BEGIN(UIMenuWndPhotoQuickView_Menu)
...
DECLARE_EVENT(UIMenuWndPhotoQuickView_Menu)
MENU_LIST_BEGIN(UIMenuWndPhotoQuickView_Menu)
MENU_LIST_ITEM(STRID_OFF32)
MENU_LIST_ITEM(STRID_2SEC33)
MENU_LIST_ITEM(STRID_5SEC34)
MENU_LIST_END

CREATE_MENU_DATA(UIMenuWndPhotoQuickView_Menu,0,3,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_CYCLE|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_NORMAL|MENU_DRAW_IMAGE)

CREATE_MENU_CTRL(UIMenuWndPhotoQuickView_Menu,UIMenuWndPhotoQuickView_Menu,0,23,3,226,41)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndPhotoQuickView_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndPhotoQuickView_Panel)
DECLARE_CTRL_LIST(UIMenuWndPhotoQuickView_Panel)
CREATE_CTRL(UIMenuWndPhotoQuickView_Panel,UIMenuWndPhotoQuickView_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
SHOW_MAP_BEGIN(UIMenuWndPhotoQuickView)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndPhotoQuickView)
DECLARE_CTRL_LIST(UIMenuWndPhotoQuickView)
CREATE_CTRL(UIMenuWndPhotoQuickView,UIMenuWndPhotoQuickView,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
