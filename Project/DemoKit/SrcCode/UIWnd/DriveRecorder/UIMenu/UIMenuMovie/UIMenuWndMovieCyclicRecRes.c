...
#ifndef UIMENUWNDMOVIECYCLICRECRES_H
#define UIMENUWNDMOVIECYCLICRECRES_H
...
CREATE_MENU_ITEM_DATA(STRID_3MIN33,STRID_3MIN,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_5MIN34,STRID_5MIN,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_10MIN35,STRID_10MIN,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
SHOW_MAP_BEGIN(UIMenuWndMovieCyclicRec_Menu)
...
DECLARE_EVENT(UIMenuWndMovieCyclicRec_Menu)
MENU_LIST_BEGIN(UIMenuWndMovieCyclicRec_Menu)
MENU_LIST_ITEM(STRID_OFF32)
MENU_LIST_ITEM(STRID_3MIN33)
MENU_LIST_ITEM(STRID_5MIN34)
MENU_LIST_ITEM(STRID_10MIN35)
MENU_LIST_END

CREATE_MENU_DATA(UIMenuWndMovieCyclicRec_Menu,0,4,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_CYCLE|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_NORMAL|MENU_DRAW_IMAGE)

CREATE_MENU_CTRL(UIMenuWndMovieCyclicRec_Menu,UIMenuWndMovieCyclicRec_Menu,0,16,5,231,42)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndMovieCyclicRec_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieCyclicRec_Panel)
DECLARE_CTRL_LIST(UIMenuWndMovieCyclicRec_Panel)
CREATE_CTRL(UIMenuWndMovieCyclicRec_Panel,UIMenuWndMovieCyclicRec_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
SHOW_MAP_BEGIN(UIMenuWndMovieCyclicRec)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieCyclicRec)
DECLARE_CTRL_LIST(UIMenuWndMovieCyclicRec)
CREATE_CTRL(UIMenuWndMovieCyclicRec,UIMenuWndMovieCyclicRec,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
