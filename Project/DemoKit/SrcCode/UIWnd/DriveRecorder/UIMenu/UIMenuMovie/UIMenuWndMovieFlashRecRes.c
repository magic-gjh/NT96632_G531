...
#ifndef UIMENUWNDMOVIEFLASHRECRES_H
#define UIMENUWNDMOVIEFLASHRECRES_H
...
SHOW_MAP_BEGIN(UIMenuWndMovieFlashRec_Menu)
...
DECLARE_EVENT(UIMenuWndMovieFlashRec_Menu)
MENU_LIST_BEGIN(UIMenuWndMovieFlashRec_Menu)
MENU_LIST_ITEM(STRID_OFF32)
MENU_LIST_ITEM(STRID_ON33)
MENU_LIST_END

CREATE_MENU_DATA(UIMenuWndMovieFlashRec_Menu,0,2,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_CYCLE|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_NORMAL|MENU_DRAW_IMAGE)

CREATE_MENU_CTRL(UIMenuWndMovieFlashRec_Menu,UIMenuWndMovieFlashRec_Menu,0,16,5,231,42)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndMovieFlashRec_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieFlashRec_Panel)
DECLARE_CTRL_LIST(UIMenuWndMovieFlashRec_Panel)
CREATE_CTRL(UIMenuWndMovieFlashRec_Panel,UIMenuWndMovieFlashRec_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
SHOW_MAP_BEGIN(UIMenuWndMovieFlashRec)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieFlashRec)
DECLARE_CTRL_LIST(UIMenuWndMovieFlashRec)
CREATE_CTRL(UIMenuWndMovieFlashRec,UIMenuWndMovieFlashRec,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
