...
#ifndef UIMENUWNDMOVIEEVRES_H
#define UIMENUWNDMOVIEEVRES_H
...
SHOW_MAP_BEGIN(UIMenuWndMovieEV_Menu)
...
DECLARE_EVENT(UIMenuWndMovieEV_Menu)
MENU_LIST_BEGIN(UIMenuWndMovieEV_Menu)
...
CREATE_MENU_DATA(UIMenuWndMovieEV_Menu,0,4,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_CYCLE|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_NORMAL|MENU_DRAW_IMAGE)

CREATE_MENU_CTRL(UIMenuWndMovieEV_Menu,UIMenuWndMovieEV_Menu,0,23,3,226,41)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndMovieEV_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieEV_Panel)
DECLARE_CTRL_LIST(UIMenuWndMovieEV_Panel)
CREATE_CTRL(UIMenuWndMovieEV_Panel,UIMenuWndMovieEV_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
SHOW_MAP_BEGIN(UIMenuWndMovieEV)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieEV)
DECLARE_CTRL_LIST(UIMenuWndMovieEV)
CREATE_CTRL(UIMenuWndMovieEV,UIMenuWndMovieEV,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
