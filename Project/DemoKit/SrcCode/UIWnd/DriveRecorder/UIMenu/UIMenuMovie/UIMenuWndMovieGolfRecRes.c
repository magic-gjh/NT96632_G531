...
#ifndef UIMENUWNDMOVIEGOLFRECRES_H
#define UIMENUWNDMOVIEGOLFRECRES_H
...
SHOW_MAP_BEGIN(UIMenuWndMovieGolfRec_Menu)
...
DECLARE_EVENT(UIMenuWndMovieGolfRec_Menu)
MENU_LIST_BEGIN(UIMenuWndMovieGolfRec_Menu)
MENU_LIST_ITEM(STRID_OFF32)
MENU_LIST_ITEM(STRID_ON33)
MENU_LIST_END

CREATE_MENU_DATA(UIMenuWndMovieGolfRec_Menu,0,2,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_CYCLE|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_NORMAL|MENU_DRAW_IMAGE)

CREATE_MENU_CTRL(UIMenuWndMovieGolfRec_Menu,UIMenuWndMovieGolfRec_Menu,0,16,5,231,42)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndMovieGolfRec_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieGolfRec_Panel)
DECLARE_CTRL_LIST(UIMenuWndMovieGolfRec_Panel)
CREATE_CTRL(UIMenuWndMovieGolfRec_Panel,UIMenuWndMovieGolfRec_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
SHOW_MAP_BEGIN(UIMenuWndMovieGolfRec)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieGolfRec)
DECLARE_CTRL_LIST(UIMenuWndMovieGolfRec)
CREATE_CTRL(UIMenuWndMovieGolfRec,UIMenuWndMovieGolfRec,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
