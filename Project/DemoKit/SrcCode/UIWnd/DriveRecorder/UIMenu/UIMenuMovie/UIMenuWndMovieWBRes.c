...
#ifndef UIMENUWNDMOVIEWBRES_H
#define UIMENUWNDMOVIEWBRES_H
...
SHOW_MAP_BEGIN(UIMenuWndMovieWB_Menu)
...
DECLARE_EVENT(UIMenuWndMovieWB_Menu)
MENU_LIST_BEGIN(UIMenuWndMovieWB_Menu)
...
CREATE_MENU_DATA(UIMenuWndMovieWB_Menu,0,4,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_CYCLE|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_NORMAL|MENU_DRAW_IMAGE)

CREATE_MENU_CTRL(UIMenuWndMovieWB_Menu,UIMenuWndMovieWB_Menu,0,44,3,247,41)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndMovieWB_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieWB_Panel)
DECLARE_CTRL_LIST(UIMenuWndMovieWB_Panel)
CREATE_CTRL(UIMenuWndMovieWB_Panel,UIMenuWndMovieWB_Panel,CTRL_WND,NULL,0 ,14,45,307,213)
SHOW_MAP_BEGIN(UIMenuWndMovieWB)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieWB)
DECLARE_CTRL_LIST(UIMenuWndMovieWB)
CREATE_CTRL(UIMenuWndMovieWB,UIMenuWndMovieWB,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
