...
#ifndef UIMENUWNDMOVIEGODBLESSRES_H
#define UIMENUWNDMOVIEGODBLESSRES_H
...
SHOW_MAP_BEGIN(UIMenuWndMovieGodBless_Menu)
...
DECLARE_EVENT(UIMenuWndMovieGodBless_Menu)
MENU_LIST_BEGIN(UIMenuWndMovieGodBless_Menu)
MENU_LIST_ITEM(STRID_OFF32)
MENU_LIST_ITEM(STRID_ON33)
MENU_LIST_END

CREATE_MENU_DATA(UIMenuWndMovieGodBless_Menu,0,2,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_CYCLE|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_NORMAL|MENU_DRAW_IMAGE)

CREATE_MENU_CTRL(UIMenuWndMovieGodBless_Menu,UIMenuWndMovieGodBless_Menu,0,16,5,231,42)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndMovieGodBless_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieGodBless_Panel)
DECLARE_CTRL_LIST(UIMenuWndMovieGodBless_Panel)
CREATE_CTRL(UIMenuWndMovieGodBless_Panel,UIMenuWndMovieGodBless_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
SHOW_MAP_BEGIN(UIMenuWndMovieGodBless)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieGodBless)
DECLARE_CTRL_LIST(UIMenuWndMovieGodBless)
CREATE_CTRL(UIMenuWndMovieGodBless,UIMenuWndMovieGodBless,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
