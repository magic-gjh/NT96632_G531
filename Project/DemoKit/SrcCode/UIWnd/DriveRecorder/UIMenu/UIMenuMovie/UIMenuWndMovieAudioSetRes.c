...
#ifndef UIMENUWNDMOVIEAUDIOSETRES_H
#define UIMENUWNDMOVIEAUDIOSETRES_H
...
SHOW_MAP_BEGIN(UIMenuWndMovieAudioSet_Menu)
...
DECLARE_EVENT(UIMenuWndMovieAudioSet_Menu)
MENU_LIST_BEGIN(UIMenuWndMovieAudioSet_Menu)
MENU_LIST_ITEM(STRID_OFF32)
MENU_LIST_ITEM(STRID_ON33)
MENU_LIST_END

CREATE_MENU_DATA(UIMenuWndMovieAudioSet_Menu,0,2,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_CYCLE|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_NORMAL|MENU_DRAW_IMAGE)

CREATE_MENU_CTRL(UIMenuWndMovieAudioSet_Menu,UIMenuWndMovieAudioSet_Menu,0,16,5,231,42)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndMovieAudioSet_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieAudioSet_Panel)
DECLARE_CTRL_LIST(UIMenuWndMovieAudioSet_Panel)
CREATE_CTRL(UIMenuWndMovieAudioSet_Panel,UIMenuWndMovieAudioSet_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
SHOW_MAP_BEGIN(UIMenuWndMovieAudioSet)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieAudioSet)
DECLARE_CTRL_LIST(UIMenuWndMovieAudioSet)
CREATE_CTRL(UIMenuWndMovieAudioSet,UIMenuWndMovieAudioSet,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
