...
#ifndef UIMENUWNDPLAYFORMATCONFIRMRES_H
#define UIMENUWNDPLAYFORMATCONFIRMRES_H
...
SHOW_MAP_BEGIN(UIMenuWndPlayFormatConfirm_List_Text)
...
DECLARE_EVENT(UIMenuWndPlayFormatConfirm_List_Text)
LIST_LIST_BEGIN(UIMenuWndPlayFormatConfirm_List_Text)
LIST_LIST_ITEM(STRID_CANCEL31)
LIST_LIST_ITEM(STRID_OK32)
LIST_LIST_END

CREATE_LIST_DATA(UIMenuWndPlayFormatConfirm_List_Text,0,2,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_STOP|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_SKIP|LIST_DRAW_IMAGE,NVTEVT_NULL)

CREATE_LIST_CTRL(UIMenuWndPlayFormatConfirm_List_Text,UIMenuWndPlayFormatConfirm_List_Text,0,72,126,287,163)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
SHOW_ITEM_GROUP(CMD_Group,Normal33,86,63,279,117)

SHOW_MAP_BEGIN(UIMenuWndPlayFormatConfirm_Static_Text)
SHOW_MAP_BODY(Normal33)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndPlayFormatConfirm_Static_Text)
CREATE_STATIC_DATA(UIMenuWndPlayFormatConfirm_Static_Text,STRID_DELETE_WARNING)
CREATE_STATIC_CTRL(UIMenuWndPlayFormatConfirm_Static_Text,0,86,63,279,117)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndPlayFormatConfirm)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_BODY(Rect3)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndPlayFormatConfirm)
DECLARE_CTRL_LIST(UIMenuWndPlayFormatConfirm)
CREATE_CTRL(UIMenuWndPlayFormatConfirm,UIMenuWndPlayFormatConfirm,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
