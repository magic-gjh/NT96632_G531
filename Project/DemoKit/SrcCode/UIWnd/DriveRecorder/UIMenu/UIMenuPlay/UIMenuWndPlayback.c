...
INT32 UIMenuWndPlayback_OnChildClose(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    UxState_SetItemData(&UIMenuWndPlayback_TitleNameCtrl,0,STATE_ITEM_STRID,STRID_PLAYBACK);//jack lan 
