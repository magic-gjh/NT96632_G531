...
#ifndef UIMENUWNDPLAYFORMATRES_H
#define UIMENUWNDPLAYFORMATRES_H
...
SHOW_MAP_BEGIN(UIMenuWndPlayFormat_List_Text)
...
DECLARE_EVENT(UIMenuWndPlayFormat_List_Text)
LIST_LIST_BEGIN(UIMenuWndPlayFormat_List_Text)
LIST_LIST_ITEM(STRID_INT_FLASH31)
LIST_LIST_ITEM(STRID_EXT_CARD32)
LIST_LIST_END

CREATE_LIST_DATA(UIMenuWndPlayFormat_List_Text,0,2,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_STOP|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_SKIP|LIST_DRAW_IMAGE,NVTEVT_NULL)

CREATE_LIST_CTRL(UIMenuWndPlayFormat_List_Text,UIMenuWndPlayFormat_List_Text,0,72,55,287,92)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndPlayFormat)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_BODY(Rect3)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndPlayFormat)
DECLARE_CTRL_LIST(UIMenuWndPlayFormat)
CREATE_CTRL(UIMenuWndPlayFormat,UIMenuWndPlayFormat,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
