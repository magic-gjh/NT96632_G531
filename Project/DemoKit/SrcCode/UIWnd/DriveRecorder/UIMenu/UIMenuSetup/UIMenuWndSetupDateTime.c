...
#define DATETIME_DEFAULT_YEAR   2013
#define DATETIME_DEFAULT_MONTH     1
#define DATETIME_DEFAULT_DAY       1
#define DATETIME_DEFAULT_HOUR      8
...
EVENT_ITEM(NVTEVT_KEY_MENU,UIMenuWndSetupDateTime_OnKeyEnter)
...
static void UIMenuWndSetupDateTime_UpdateInfo(void)
{
    ...
    UxButton_SetItemData(&UIMenuWndSetupDateTime_YMD_SwitchCtrl, 0, BTNITM_STRID, STRID_DD);        
    UxStatic_SetData(&UIMenuWndSetupDateTime_YMD_VALUE_Other4Ctrl, STATIC_VALUE, STRID_D_M_Y);	        
        {
    ...
    UxButton_SetItemData(&UIMenuWndSetupDateTime_YMD_SwitchCtrl, 0, BTNITM_STRID, STRID_MM);        
    UxStatic_SetData(&UIMenuWndSetupDateTime_YMD_VALUE_Other4Ctrl, STATIC_VALUE, STRID_M_D_Y);	        
        {
    ...
    UxButton_SetItemData(&UIMenuWndSetupDateTime_YMD_SwitchCtrl, 0, BTNITM_STRID, STRID_YY);        
    UxStatic_SetData(&UIMenuWndSetupDateTime_YMD_VALUE_Other4Ctrl, STATIC_VALUE, STRID_Y_M_D);	        
        {
...
EVENT_ITEM(NVTEVT_KEY_ENTER,UIMenuWndSetupDateTime_Tab_OnKeyRight)
