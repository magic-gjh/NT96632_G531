...
CREATE_LIST_ITEM_DATA(STRID_50HZ31,STRID_50HZ,ICONID_NULL,STATUS_ENABLE) 
CREATE_LIST_ITEM_DATA(STRID_60HZ32,STRID_60HZ,ICONID_NULL,STATUS_ENABLE) 
SHOW_MAP_BEGIN(UIMenuWndSetupFrequency_List_Text)
...
DECLARE_EVENT(UIMenuWndSetupFrequency_List_Text)
LIST_LIST_BEGIN(UIMenuWndSetupFrequency_List_Text)
LIST_LIST_ITEM(STRID_50HZ31)
LIST_LIST_ITEM(STRID_60HZ32)
LIST_LIST_END

CREATE_LIST_DATA(UIMenuWndSetupFrequency_List_Text,0,2,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_STOP|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_SKIP|LIST_DRAW_IMAGE,NVTEVT_NULL)

CREATE_LIST_CTRL(UIMenuWndSetupFrequency_List_Text,UIMenuWndSetupFrequency_List_Text,0,72,55,287,92)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
