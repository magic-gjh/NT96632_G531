...
#ifndef UIMENUWNDSETUPTVMODERES_H
#define UIMENUWNDSETUPTVMODERES_H
...
CREATE_LIST_ITEM_DATA(STRID_TV_NTSC31,STRID_TV_NTSC,ICONID_NULL,STATUS_ENABLE) 
CREATE_LIST_ITEM_DATA(STRID_TV_PAL32,STRID_TV_PAL,ICONID_NULL,STATUS_ENABLE) 
SHOW_MAP_BEGIN(UIMenuWndSetupTVMode_List_Text)
...
DECLARE_EVENT(UIMenuWndSetupTVMode_List_Text)
LIST_LIST_BEGIN(UIMenuWndSetupTVMode_List_Text)
LIST_LIST_ITEM(STRID_TV_NTSC31)
LIST_LIST_ITEM(STRID_TV_PAL32)
LIST_LIST_END

CREATE_LIST_DATA(UIMenuWndSetupTVMode_List_Text,0,2,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_STOP|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_SKIP|LIST_DRAW_IMAGE,NVTEVT_NULL)

CREATE_LIST_CTRL(UIMenuWndSetupTVMode_List_Text,UIMenuWndSetupTVMode_List_Text,0,72,55,287,92)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndSetupTVMode)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_BODY(Rect3)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndSetupTVMode)
DECLARE_CTRL_LIST(UIMenuWndSetupTVMode)
CREATE_CTRL(UIMenuWndSetupTVMode,UIMenuWndSetupTVMode,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
