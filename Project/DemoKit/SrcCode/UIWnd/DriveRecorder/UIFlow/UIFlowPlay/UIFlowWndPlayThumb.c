...
INT32 UIFlowWndPlayThumb_OnKeyZoomout(VControl *, UINT32, UINT32 *);
INT32 UIFlowWndPlayThumb_OnKeyShutter2(VControl *, UINT32, UINT32 *);
INT32 UIFlowWndPlayThumb_OnKeyPlayback(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_KEY_ZOOMOUT,UIFlowWndPlayThumb_OnKeyZoomout)
EVENT_ITEM(NVTEVT_KEY_SHUTTER2,UIFlowWndPlayThumb_OnKeyShutter2)
EVENT_ITEM(NVTEVT_KEY_PLAYBACK,UIFlowWndPlayThumb_OnKeyPlayback)
EVENT_END

static INT32 UIFlowWndPlayThumb_OnExeUpKeyAct(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    //#NT#2009/10/20#Chris Chung -begin
    ...
    //#NT#2009/10/20#Chris Chung -end
    return NVTEVT_CONSUME;
}

static INT32 UIFlowWndPlayThumb_OnExeDownKeyAct(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    //#NT#2009/10/20#Chris Chung -begin
    KeyScan_SetKeyMask(KEYSCAN_KEYMODE_PRESS, FLGKEY_KEY_MASK_NULL);
...
static INT32 UIFlowWndPlayThumb_OnExeEnterKeyAct(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
...
{
    return UIFlowWndPlayThumb_OnExeUpKeyAct(pCtrl, paramNum, paramArray);
}
INT32 UIFlowWndPlayThumb_OnKeyDown(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    return UIFlowWndPlayThumb_OnExeDownKeyAct(pCtrl, paramNum, paramArray);
}
...
{
    return UIFlowWndPlayThumb_OnExeEnterKeyAct(pCtrl, paramNum, paramArray);
}
...
INT32 UIFlowWndPlayThumb_OnKeyZoomout(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    return UIFlowWndPlayThumb_OnExeDownKeyAct(pCtrl, paramNum, paramArray);
}
...
INT32 UIFlowWndPlayThumb_OnKeyPlayback(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    return NVTEVT_CONSUME;
}
