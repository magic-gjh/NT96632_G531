...
#define T00_FBVOL_45            0x00
#define T00_FBVOL_50            0x01
#define T00_FBVOL_55            0x02
#define T00_FBVOL_59            0x03
#define T00_FBVOL_64            0x04
#define T00_FBVOL_69            0x05
#define T00_FBVOL_73            0x06
#define T00_FBVOL_78            0x07
#define T00_PWM_DUTY_75         0x00
#define T00_PWM_DUTY_55         0x08
#define T00_PWM_DUTY_60         0x10
#define T00_PWM_DUTY_65         0x18
//R00 Macro Settings
...
#define T00_MODE                (T00_PWM_DUTY_55|T00_FBVOL_45)
...
static tPANEL_CMD tCmdModeRGB[] = {
    ...
    {REG_T00,T00_MODE},  //Internal PWM On,Others are Default
};
//#NT#2008/12/23#Niven Cho -end
...
void DeviceOpen(LCDSIZE *psizeDisplay)
{
    ...
    ide_setIcstCoef(ACCRCY_1_2_8,CoefTrans);

    ide_setOutOffset(0x00,0x00,0x00);
