...
/*
            ...
            sendtoAUBL02LCDreg(0x04, 0x1b);
            sendtoAUBL02LCDreg(0x05, 0x57);
*/
            if(LCD_DeviceObj.LCDCtrl_Pin.uimode == LCD_CTRL_MODE_SIF)
            {
                sendtoAUBL02LCDreg(0x04,0x0B);  //UPS051
                sendtoAUBL02LCDreg(0x05,0x75|gAUBL02_POWERBOOST);
                sendtoAUBL02LCDreg(0x06,0x15);
                sendtoAUBL02LCDreg(0x07,0x1E);
                sendtoAUBL02LCDreg(0x08,0x04);
                gAUBL02_POWER_CTRL = 0x75|gAUBL02_POWERBOOST;
            }
            else
            {
                sendtoAUBL02LCDreg(0x04,0x0B);  //UPS051
                sendtoAUBL02LCDreg(0x04,0x0B);  //UPS051, program two times to avoid setting in vsync active area.
                sendtoAUBL02LCDreg(0x06,0x15);  //15
                sendtoAUBL02LCDreg(0x06,0x15);
                sendtoAUBL02LCDreg(0x07,0x1E);
                sendtoAUBL02LCDreg(0x07,0x1E);
                sendtoAUBL02LCDreg(0x08,0x04);
