/*
    ...
    @ingroup    mILIBLCDAUA030DN01.c

    @brief      AU LCD Driver of AUA030DN01 panel
...
#if 1
#define AU_DN01_UPS052_Buf_width       424//michael set  to  16:9  ////320
...
static void Init_AUDN01_LCD(void)
{
    ...
    case LCD_MODE_RGBD:
        ...
        //sendtoAUDN01LCDreg(0x05,0xdf);
        sendtoAUDN01LCDreg(0x04,0x1B);
        sendtoAUDN01LCDreg(0x06,0x03);
        sendtoAUDN01LCDreg(0x07,0x19);
        sendtoAUDN01LCDreg(0x08,0xc0);
        break;
    case LCD_MODE_YUV:
...
void OpenAUDN01(LCDSIZE *psizeDisplay)
{
    ...
    case LCD_MODE_RGBD:
        ...
        ide_set_icst(0);
        ide_setICST(TRUE,CST_YCBCR2RGB);//ide_configIcst(TRUE, CST_YCBCR2RGB);
        ...
        ide_set_hor_timing(0x01, 1560, 241, 1521);
        ide_set_ver_timing(0x01, 262, 1, 241, 1, 241);
...
void LCD_Rotate(UINT32 bRotate)
{
    ...
    if (bRotate)
    {
        ...
        ide_set_load();
        sendtoAUDN01LCDreg(0x04,INPUT_FORMAT_UPS052_320_ROTATE);//11B
    }
    else
    {
        ide_wait_frame_end();
        ...
        ide_set_pdir(IDE_PDIR_RGB);
        ide_set_load();
        sendtoAUDN01LCDreg(0x04,INPUT_FORMAT_UPS052_320);//18
    }
    return;
}
