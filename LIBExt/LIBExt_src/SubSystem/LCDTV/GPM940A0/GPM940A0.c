/*
    ...
    @ingroup    mILIBLCDGPM940A0

    @brief      AU LCD Driver of AU GPM940A0 panel
...
#define GPM940A0_UPS051_Buf_width       960
#define GPM940A0_UPS051_Buf_height      240
#define GPM940A0_UPS051_Win_width       960
#define GPM940A0_UPS051_Win_height      240

#define GPM940A0_THROUGH_Buf_width      320
#define GPM940A0_THROUGH_Buf_height     240
#define GPM940A0_THROUGH_Win_width      320
#define GPM940A0_THROUGH_Win_height     240

#define GPM940A0_UPS052_Buf_width       320
#define GPM940A0_UPS052_Buf_height      240
#define GPM940A0_UPS052_Win_width       320
#define GPM940A0_UPS052_Win_height      240

#define GPM940A0_CCIR656_Buf_width      720
#define GPM940A0_CCIR656_Buf_height     480
#define GPM940A0_CCIR656_Win_width      720
#define GPM940A0_CCIR656_Win_height     480

#define GPM940A0_YUV640_Buf_width       640
#define GPM940A0_YUV640_Buf_height      240
#define GPM940A0_YUV640_Win_width       640
#define GPM940A0_YUV640_Win_height      240

//UINT8 gGPM940A0_VCOM_DC = 0x18;

//function declaration
static void delay(UINT32 times);
static void sendtoGPM940A0LCDreg_sif(UINT8 addr, UINT8 value);
static void sendtoGPM940A0LCDreg_gpio(UINT8 addr, UINT8 value);
static void sendtoGPM940A0LCDreg(UINT8 addr, UINT8 value);

static void Init_GPM940A0_LCD(void);
static void OpenGPM940A0(LCDSIZE *psizeDisplay);
static void CloseGPM940A0(void);
...
{
    sendtoGPM940A0LCDreg(addr, value);
}
...
static void sendtoGPM940A0LCDreg(UINT8 addr, UINT8 value)
{
    ...
    {
         sendtoGPM940A0LCDreg_sif(addr, value);
    }
    else
    {
         sendtoGPM940A0LCDreg_gpio(addr, value);
    }
}
//#NT#2009/09/24#SA4 -begin
void sendtoGPM940A0LCDreg2(UINT8 addr, UINT8 value)
{
    debug_err(("sendtoGPM940A0LCDreg2,addr = 0x%x,value=0x%x\n\r",addr,value));
    sendtoGPM940A0LCDreg(addr,value);
}
/*
void readGPM940A0LCDreg_gpio(UINT8 addr, UINT8 *value)
{
    UINT32 data;
    UINT32 j;
    UINT32 temp;
...
/*
    Initial LCD of GPM940A0, configure SIF intarface and send data to panel register to configure
*/
static void Init_GPM940A0_LCD(void)
{
    SIF_CTRL    SIFCtrl;
    ...
    {
    case LCD_MODE_RGBD:
        sendtoGPM940A0LCDreg(0x05,0x1E);    // Global reset
        sendtoGPM940A0LCDreg(0x05,0x5E);    // Global reset recovery
        sendtoGPM940A0LCDreg(0x04,0x1B);    // Set UPS052 320 mode
        sendtoGPM940A0LCDreg(0x05,0x5F);    // Release standby
        break;
    case LCD_MODE_CCIR656:
        sendtoGPM940A0LCDreg(0x05,0x1E);    // Global reset
        sendtoGPM940A0LCDreg(0x05,0x5E);    // Global reset recovery
        sendtoGPM940A0LCDreg(0x00,0x05);    // Set CCIR601 = 0
        sendtoGPM940A0LCDreg(0x04,0x6B);    // Set CCIR656 mode
        sendtoGPM940A0LCDreg(0x05,0x5F);    // Release standby
        break;
    case LCD_MODE_YUV:
        sendtoGPM940A0LCDreg(0x05,0x1E);    // Global reset
        sendtoGPM940A0LCDreg(0x05,0x5E);    // Global reset recovery
        sendtoGPM940A0LCDreg(0x00,0x45);    // Set CCIR601 = 1
        sendtoGPM940A0LCDreg(0x04,0x4B);    // Set YUV 640 mode
        sendtoGPM940A0LCDreg(0x05,0x5F);    // Release standby
        break;
    case LCD_MODE_UPS051:
        sendtoGPM940A0LCDreg(0x05,0x1E);    // Global reset
        sendtoGPM940A0LCDreg(0x05,0x5E);    // Global reset recovery
        sendtoGPM940A0LCDreg(0x04,0x0B);    // Set UPS051 mode
        sendtoGPM940A0LCDreg(0x05,0x5F);    // Release standby
        break;
    case LCD_MODE_RGB_THROUGH:
        sendtoGPM940A0LCDreg(0x05,0x1E);    // Global reset
        ...
        break;
    default:
        debug_err(("Init_GPM940A0_LCD() not support %d\r\n", LCD_DeviceObj.uiLCDMode));
        break;
    }
}
}
/*
  Open GPM940A0 panel driver, configure IDE related register, private function for internal used
...
static void OpenGPM940A0(LCDSIZE *psizeDisplay)
{
    ...
    case LCD_MODE_RGBD:
        ...
        ide_set_hor_timing(0x00, 0x617, 0xF1, 0x5F1);
        ...
        psizeDisplay->uiWidth      = GPM940A0_UPS052_Buf_width;
        psizeDisplay->uiHeight     = GPM940A0_UPS052_Buf_height;
        psizeDisplay->uiWinWidth   = GPM940A0_UPS052_Win_width;
        psizeDisplay->uiWinHeight  = GPM940A0_UPS052_Win_height;
        break;
    ...
    case LCD_MODE_CCIR656:
        ...
        psizeDisplay->uiWidth = GPM940A0_CCIR656_Buf_width;
        psizeDisplay->uiHeight = GPM940A0_CCIR656_Buf_height;
        psizeDisplay->uiWinWidth = GPM940A0_CCIR656_Win_width;
        psizeDisplay->uiWinHeight = GPM940A0_CCIR656_Win_height;
        break;
    ...
    case LCD_MODE_YUV:
        ...
        psizeDisplay->uiWidth       = GPM940A0_YUV640_Buf_width;
        psizeDisplay->uiHeight      = GPM940A0_YUV640_Buf_height;
        psizeDisplay->uiWinWidth    = GPM940A0_YUV640_Win_width;
        psizeDisplay->uiWinHeight   = GPM940A0_YUV640_Win_height;
        break;
    case LCD_MODE_UPS051:
        pinmux_select_lcd(PINMUX_LCD_SERIAL_RGB_8BIT);
        ...
        psizeDisplay->uiWidth       = GPM940A0_UPS051_Buf_width;
        psizeDisplay->uiHeight      = GPM940A0_UPS051_Buf_height;
        psizeDisplay->uiWinWidth    = GPM940A0_UPS051_Win_width;
        psizeDisplay->uiWinHeight   = GPM940A0_UPS051_Win_height;
        break;
    case LCD_MODE_RGB_THROUGH:
        pinmux_select_lcd(PINMUX_LCD_SERIAL_RGB_8BIT);
        ...
        psizeDisplay->uiWidth       = GPM940A0_THROUGH_Buf_width;
        psizeDisplay->uiHeight      = GPM940A0_THROUGH_Buf_height;
        psizeDisplay->uiWinWidth    = GPM940A0_THROUGH_Win_width;
        psizeDisplay->uiWinHeight   = GPM940A0_THROUGH_Win_height;
        break;
    default:
        debug_err(("OpenGPM940A0() Not support %d mode\r\n",LCD_DeviceObj.uiLCDMode));
        break;
    }
...
/*
  Close GPM940A0 driver

  Release GPM940A0 driver, private function for internal used
*/
static void CloseGPM940A0(void)
{
    // Change to standby mode
    sendtoGPM940A0LCDreg(0x05,0x5E);    // Set standby
...
void LCD_Rotate(UINT32 bRotate)
{
    ...
    if (bRotate)
    {
        ...
        ide_set_load();
        sendtoGPM940A0LCDreg2(0x04,0x08);
    }
    else
    {
        ide_wait_frame_end();
        ...
        ide_set_pdir(IDE_PDIR_RGB);
        ide_set_load();
        sendtoGPM940A0LCDreg2(0x04,0x0B);
    }
}
typedef enum
{
...
void LCD_Brightness(UINT32 level)
{
    ...
    case GMP_LCDBRT_LVL_00:
        sendtoGPM940A0LCDreg2(0x06,(0x15 | 0x60));
        break;
    case GMP_LCDBRT_LVL_01:
        sendtoGPM940A0LCDreg2(0x06,(0x15 | 0x40));
        break;
    case GMP_LCDBRT_LVL_02:
        sendtoGPM940A0LCDreg2(0x06,(0x15 | 0x00));
        break;
    case GMP_LCDBRT_LVL_03:
        sendtoGPM940A0LCDreg2(0x06,(0x15 | 0x20));
        break;
    }
}
...
{
    if(status == TRUE)
        sendtoGPM940A0LCDreg(0x05,0x5F);
    else
        sendtoGPM940A0LCDreg(0x05,0x5D);
}
