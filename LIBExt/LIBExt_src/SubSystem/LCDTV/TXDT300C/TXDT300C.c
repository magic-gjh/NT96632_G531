...
#if 1
#define AU_DN01_UPS052_Buf_width       424// for 16:9 panel ration//320
...
static void Init_TXDT300C_LCD(void);
static void OpenTXDT300C(LCDSIZE *psizeDisplay);
void CloseTXDT300C(void);
...
static void Init_TXDT300C_LCD(void)
{
    ...
    case LCD_MODE_RGBD:
        ...
        sendtoAUDN01LCDreg(0x01,0x8b);
        sendtoAUDN01LCDreg(0x03,0x38); //0x32
        sendtoAUDN01LCDreg(0x0b,0x81);
        //sendtoAUDN01LCDreg(0x06,0x95);
        //sendtoAUDN01LCDreg(0x07,0x46);
        sendtoAUDN01LCDreg(0x16,0x00);
        sendtoAUDN01LCDreg(0x17,0x77);
        sendtoAUDN01LCDreg(0x18,0x77);
        sendtoAUDN01LCDreg(0x19,0x33);
        sendtoAUDN01LCDreg(0x1a,0x43);
        //sendtoAUDN01LCDreg(0x95,0x80); //
        sendtoAUDN01LCDreg(0xaf,0x04);
        sendtoAUDN01LCDreg(0xa5,0x22);
        sendtoAUDN01LCDreg(0xa6,0x12); //66
        sendtoAUDN01LCDreg(0xa7,0x06); //67
    ...
    case LCD_MODE_RGB:
        ...
        sendtoAUDN01LCDreg(0x00,0x0b);
        sendtoAUDN01LCDreg(0x01,0x8b);
        sendtoAUDN01LCDreg(0x03,0x40); //0x32
        sendtoAUDN01LCDreg(0x0b,0x81);
        //sendtoAUDN01LCDreg(0x06,0x95);
        //sendtoAUDN01LCDreg(0x07,0x46);
        sendtoAUDN01LCDreg(0x16,0x00);
...
/**
  ...
  @param psizeDisplay initial LCD size by upper layer
*/
void OpenTXDT300C(LCDSIZE *psizeDisplay)
{
    UINT8   uiClockDiv;
...
//        ide_set_ctrst(0x40);
    ...
    case LCD_MODE_RGBD:
        ...
        ide_set_hor_timing(1, 1559, 241, 1521);
        ide_set_ver_timing(0, 261, 21, 261, 21, 261);
        ide_set_interlace(0x00);
        ide_set_startfield(0x00);
...
void TXDT300COpenLcdBacklightReg(void)
{
