...
#else//A1040
UINT Rgain=344,Bgain=360,Ggain=256,OldRgain=344,OldBgain=360,OldGgain=256;
#endif
...
void aaa_InitRBgain(void)
{
    ...
    Bgain =345;
#else //A1040
    Rgain =344;//eric 20111113
    Bgain =360;//eric 20111113
#endif
    PhotoAWBEnter=1;
...
//#NT#modify for ca process
    ...
    //#NT#2009/11/09#JJ Huang -begin
    //CA_para.Cfapat = 0;//The CfaPat translation doesn't fit the raw//Sen_GetIPECfaPat(CFAPAT_PRV, gImageAlgInfo.ImageFlip);
    CA_para.Cfapat = Sen_GetIPECfaPat(CFAPAT_PRV, gImageAlgInfo.ImageFlip);
    //#NT#2009/11/09#JJ Huang -end
