...
//#NT#
/************** NTSC_MODE **************/
#define VD_Sync_Prv_NTSC             4
#define HD_Sync_Prv_NTSC             128

#define VD_Total_Prv_NTSC            246
#define HD_Total_Prv_NTSC            1578

#define ACT_STRX_Prv_NTSC            140
#define ACT_STRY_Prv_NTSC            20

#define SIE_PRV_XCENTER_NTSC         (ACT_STRX_Prv_NTSC+(1440/2))
#define SIE_PRV_YCENTER_NTSC         (ACT_STRY_Prv_NTSC+(224/2))

#define Padding_Prv_NTSC   0

/************** PAL_MODE **************/

#define VD_Sync_Prv_PAL             4
#define HD_Sync_Prv_PAL             128

#define VD_Total_Prv_PAL            300
#define HD_Total_Prv_PAL            1588

#define ACT_STRX_Prv_PAL            148
#define ACT_STRY_Prv_PAL            28

#define SIE_PRV_XCENTER_PAL         (ACT_STRX_Prv_PAL+(1440/2))
#define SIE_PRV_YCENTER_PAL         (ACT_STRY_Prv_PAL+(264/2))

#define Padding_Prv_PAL   0
...
//#NT#2011/09/09#Spark Chou -begin
//#NT#
#define DVI_FORMAT          DVI_YCRYCB //DVI_CBYCRY
