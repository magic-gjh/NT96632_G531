...
__align(4) IPE_DYNAIQ_PARAM  IPE_DynaIQ_Param[Total_ISONum] =
{
   ...
   // For Preview & Video
#if 0
    {  100,    240,  36,     512,    32,   28,     8,       8,      0,     0,     0,     0},
    {  200,    220,  48,     512,    32,   28,    16,       8,      0,     0,     0,     0},
    {  400,    180,  64,     512,    48,   36,    32,      16,     16,    16,    16,    16},
	{  600,    140,  80,     512,    63,   48,    48,      24,     24,    24,    24,    24},
#endif
#if 1
    {  100,    240,  36,     512,    32,   28,     8,       8,      0,     0,     0,     0},
    {  200,    220,  44,     512,    32,   28,    16,       8,      0,     0,     0,     0},
    {  300,    180,  52,     512,    48,   36,    32,      16,     16,    16,    16,    16},
	{  500,    140,  64,     512,    63,   48,    48,      24,     24,    24,    24,    24},
#endif
#if 0
    {  100,    240,  2,     512,    32,   28,     8,       8,      0,     0,     0,     0},
    {  200,    220,  4,     512,    32,   28,    16,       8,      0,     0,     0,     0},
    {  400,    180,  8,     512,    48,   36,    32,      16,     16,    16,    16,    16},
	{  600,    140,  10,     512,    63,   48,    64,      64,     64,    64,    64,    64},
#endif
    // Capture
    {  100,    120,   6,     512,    32,   28,     8,       8,     32,    32,    32,    32},
    {  200,    110,   8,     512,    32,   28,    16,       8,     40,    40,    40,    40},
    {  400,     90,  10,     512,    48,   36,    32,      16,     48,    48,    48,    48},
{ISO_MAX_RATIO, 70,  16,     512,    63,   48,    64,      64,     64,    64,    64,    64},
...
//   RBW, GW, GBAL, OUTL, OutlRbw, OutlGw, Honly, Nsndir, Nsvsb, NsGain, Nsmar, Lpfw, Sumsel, Dthr,         Nthr[4]
    {32,   24,    0,    0,       0,      0,     0,      0,     2,     64,    18,    7,      0,   86, { 24,  24,  24,  24}},
    {63,   32,    0,    0,      54,     32,     0,      0,     2,     64,    18,    7,      0,   86, { 80,  80,  80,  80}},
 ...
 __align(4) UINT8 IPE_fmStab[Total_ISONum][16]=
{
     ...
     {128, 96, 64, 32, 16,  8, 4, 2, 0, 0, 0, 0,64,128,255,255},
	 {144,116, 88, 60, 30, 15, 8, 2, 0, 0, 0, 0,64,128,255,255},
...
#if 0
  64,   85,  104,  124,  144,  162,  179,  197,  214,  229, 
 245,  260,  276,  291,  306,  322,  337,  347,  358,  369, 
 379,  389,  401,  411,  422,  432,  442,  453,  463,  473, 
 483,  492,  502,  511,  520,  530,  539,  548,  554,  561, 
 568,  574,  581,  588,  595,  602,  605,  612,  618,  623, 
 629,  634,  640,  645,  651,  657,  661,  665,  669,  674, 
 678,  682,  687,  691,  694,  698,  701,  705,  709,  713, 
 717,  721,  724,  728,  732,  735,  739,  742,  746,  749, 
 752,  756,  759,  763,  767,  770,  775,  778,  782,  786, 
 790,  794,  800,  804,  807,  811,  814,  818,  821,  824, 
 828,  835,  838,  842,  845,  848,  852,  855,  859,  862, 
 869,  872,  876,  879,  883,  886,  889,  893,  896,  903, 
 907,  910,  913,  917,  920,  924,  927,  934,  940, 
#endif
