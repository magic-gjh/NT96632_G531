...
UINT32  SensorModeMap(_IMGResolution_sel _mode)
{
    ...
    if ( gImageAlgInfo.TvInFormat == _TvInFormat_Mode1 )
	{
    	...
    	return MONITOR_MODE_DVI1;
	}
    else if ( gImageAlgInfo.TvInFormat == _TvInFormat_Mode2 )
	{
        UI_SetParameter(_ImageRatio, _Ratio_4_3);
        return MONITOR_MODE_DVI2;
	}
    else if ( gImageAlgInfo.TvInFormat == _TvInFormat_Mode3)
	{
        UI_SetParameter(_ImageRatio, _Ratio_8_3);
        return MONITOR_MODE_DVI3;
	}
}
...
//#NT#2009/10/16#Jarkko Chang -begin
    ...
    if (GetIPPFuncInfor(DVI_MODE_EN) == ENABLE)
    {
        ...
        SIE_PRE_Para_prv.SieHDPhase = SieLoad_FallingEdge; //SieLoad_RisingEdge ;
        SIE_PRE_Para_prv.SieVDPhase = SieLoad_RisingEdge;
        SIE_PRE_Para_prv.SieDataPhase = SieLoad_RisingEdge; //SieLoad_FallingEdge; //SieLoad_RisingEdge;
...
//#NT#2009/08/25#Jarkko Chang -end
  ...
  if(job_req->SIE_PRE_PRV->PreFuncEn & PRE_VIG_EN){
    ...
    //#NT#2009/08/04#Jarkko Chang -end
        ...
        } else if( (job_req->SIE_PRE_PRV->ModeSel==MONITOR_MODE_DVI1) ||(job_req->SIE_PRE_PRV->ModeSel==MONITOR_MODE_DVI2)||(job_req->SIE_PRE_PRV->ModeSel==MONITOR_MODE_DVI3))
        {
    //#NT#2009/08/04#Jarkko Chang -begin
          job_req->pre_vig_setting.VIG_R_LUT = Shading_Table_R;
          job_req->pre_vig_setting.VIG_G_LUT = Shading_Table_G;
    ...
    switch(Type)
    {
        ...
        case SENSOR_OUT_PROGRESSIVE:
            //pll_setClockFreq(SIEMCLK_FREQ, 12000000);
              pll_setClockFreq(SIEMCLK_FREQ, 9600000);
            break;
    }
...
void SetSensorMode(INT32 Mode)
{
    ...
    switch(Mode)
    {
        ...
        case MONITOR_MODE_DVI1:
            SetIPPSizeInfor(_SieXcenter, SIE_PRV_XCENTER_DVI1);
            SetIPPSizeInfor(_SieYcenter, SIE_PRV_YCENTER_DVI1);
            SetIPPSizeInfor(_HDTotal_Preview, HD_Total_Prv_DVI1);
            SetIPPSizeInfor(_HDSync_Preview, HD_Sync_Prv_DVI1);
            SetIPPSizeInfor(_VDTotal_Preview, VD_Total_Prv_DVI1);
            SetIPPSizeInfor(_VDSync_Preview, VD_Sync_Prv_DVI1);
            SetIPPSizeInfor(_HDActX_Preview, ACT_STRX_Prv_DVI1);
            SetIPPSizeInfor(_HDActY_Preview, ACT_STRY_Prv_DVI1);
            ...
            SetIPPSizeInfor(_CAVSub, PreCA_Subsample_1_2);
            break;
	 case MONITOR_MODE_DVI2:
            SetIPPSizeInfor(_SieXcenter, SIE_PRV_XCENTER_DVI2);
            SetIPPSizeInfor(_SieYcenter, SIE_PRV_YCENTER_DVI2);
            SetIPPSizeInfor(_HDTotal_Preview, HD_Total_Prv_DVI2);
            SetIPPSizeInfor(_HDSync_Preview, HD_Sync_Prv_DVI2);
            SetIPPSizeInfor(_VDTotal_Preview, VD_Total_Prv_DVI2);
            SetIPPSizeInfor(_VDSync_Preview, VD_Sync_Prv_DVI2);
            SetIPPSizeInfor(_HDActX_Preview, ACT_STRX_Prv_DVI2);
            SetIPPSizeInfor(_HDActY_Preview, ACT_STRY_Prv_DVI2);
            ...
            SetIPPSizeInfor(_CAVSub, PreCA_Subsample_1_2);
            break;
	 case MONITOR_MODE_DVI3:
            SetIPPSizeInfor(_SieXcenter, SIE_PRV_XCENTER_DVI3);
            SetIPPSizeInfor(_SieYcenter, SIE_PRV_YCENTER_DVI3);
            SetIPPSizeInfor(_HDTotal_Preview, HD_Total_Prv_DVI3);
            SetIPPSizeInfor(_HDSync_Preview, HD_Sync_Prv_DVI3);
            SetIPPSizeInfor(_VDTotal_Preview, VD_Total_Prv_DVI3);
            SetIPPSizeInfor(_VDSync_Preview, VD_Sync_Prv_DVI3);
            SetIPPSizeInfor(_HDActX_Preview, ACT_STRX_Prv_DVI3);
            SetIPPSizeInfor(_HDActY_Preview, ACT_STRY_Prv_DVI3);
        ...
        case STILL_MODE:
            ...
            if (GetIPPFuncInfor(DVI_MODE_EN) == ENABLE)
            {
                if ( gImageAlgInfo.TvInFormat == _TvInFormat_Mode1 )
                {
                    SetIPPSizeInfor(_SieXcenter, SIE_PRV_XCENTER_DVI1);
                    SetIPPSizeInfor(_SieYcenter, SIE_PRV_YCENTER_DVI1);
                    SetIPPSizeInfor(_HDTotal_Captrue, HD_Total_Prv_DVI1);
                    SetIPPSizeInfor(_HDSync_Captrue, HD_Sync_Prv_DVI1);
                    SetIPPSizeInfor(_VDTotal_Captrue, VD_Total_Prv_DVI1);
                    SetIPPSizeInfor(_VDSync_Captrue, VD_Sync_Prv_DVI1);
                    SetIPPSizeInfor(_HDActX_Capture, ACT_STRX_Prv_DVI1);
                    SetIPPSizeInfor(_HDActY1_Capture, ACT_STRY_Prv_DVI1);
                }
                else if ( gImageAlgInfo.TvInFormat == _TvInFormat_Mode2 )
                {
                    SetIPPSizeInfor(_SieXcenter, SIE_PRV_XCENTER_DVI2);
                    SetIPPSizeInfor(_SieYcenter, SIE_PRV_YCENTER_DVI2);
                    SetIPPSizeInfor(_HDTotal_Captrue, HD_Total_Prv_DVI2);
                    SetIPPSizeInfor(_HDSync_Captrue, HD_Sync_Prv_DVI2);
                    SetIPPSizeInfor(_VDTotal_Captrue, VD_Total_Prv_DVI2);
                    SetIPPSizeInfor(_VDSync_Captrue, VD_Sync_Prv_DVI2);
                    SetIPPSizeInfor(_HDActX_Capture, ACT_STRX_Prv_DVI2);
                    SetIPPSizeInfor(_HDActY1_Capture, ACT_STRY_Prv_DVI2);
                }
                else if ( gImageAlgInfo.TvInFormat == _TvInFormat_Mode3 )
                {
                    SetIPPSizeInfor(_SieXcenter, SIE_PRV_XCENTER_DVI3);
                    SetIPPSizeInfor(_SieYcenter, SIE_PRV_YCENTER_DVI3);
                    SetIPPSizeInfor(_HDTotal_Captrue, HD_Total_Prv_DVI3);
                    SetIPPSizeInfor(_HDSync_Captrue, HD_Sync_Prv_DVI3);
                    SetIPPSizeInfor(_VDTotal_Captrue, VD_Total_Prv_DVI3);
                    SetIPPSizeInfor(_VDSync_Captrue, VD_Sync_Prv_DVI3);
                    SetIPPSizeInfor(_HDActX_Capture, ACT_STRX_Prv_DVI3);
                    SetIPPSizeInfor(_HDActY1_Capture, ACT_STRY_Prv_DVI3);
                }
            }
            break;
    }
