...
static void     lensFF_focus_gotoPosition(INT16 position);
...
*/
PLENS_TAB lensFF_getObject(void)
{
    return &g_pFFObj;
}
...
static INT32 lensFF_focus_gotoGarage(void)
{
    ...
    {
        lensFF_focus_gotoPosition(FOCUS_POS_GARAGE);
        return ERR_OK;
    }
    else
    {
