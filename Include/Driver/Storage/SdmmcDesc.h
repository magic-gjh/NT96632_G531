...
typedef struct
{
    ...
    UINT    uiSizeProtectArea;  // Size of protected area
...
typedef struct
{
    ...
    UINT16   usFunGroup6Info;       // Function group6 Info. (reserved)
    UINT16   usFunGroup5Info;       // Function group5 Info. (reserved)
    UINT16   usFunGroup4Info;       // Function group4 Info. (reserved)
    UINT16   usFunGroup3Info;       // Function group3 Info. (reserved)
    UINT16   usFunGroup2Info;       // Function group2 Info. (command system)
    UINT16   usFunGroup1Info;       // Function group1 Info. (access mode)
    UINT8    ucFunGroup6Result;     // Function Group6 Result. (reserved)
    UINT8    ucFunGroup5Result;     // Function Group5 Result. (reserved)
    UINT8    ucFunGroup4Result;     // Function Group4 Result. (reserved)
    UINT8    ucFunGroup3Result;     // Function Group3 Result. (reserved)
    UINT8    ucFunGroup2Result;     // Function Group2 Result. (command system)
    UINT8    ucFunGroup1Result;     // Function Group1 Result. (access mode)
    UINT8    ucDataStructVer;       // Data Structure Version
    UINT16   usFunGroup6BusySts;    // Function group6 Busy Status. (reserved)
    UINT16   usFunGroup5BusySts;    // Function group5 Busy Status. (reserved)
    UINT16   usFunGroup4BusySts;    // Function group4 Busy Status. (reserved)
    UINT16   usFunGroup3BusySts;    // Function group3 Busy Status. (reserved)
    UINT16   usFunGroup2BusySts;    // Function group2 Busy Status. (command system)
    UINT16   usFunGroup1BusySts;    // Function group1 Busy Status. (access mode)
