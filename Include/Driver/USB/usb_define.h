...
#define USB_REQUEST_MASK                        0xFF    ///< request mask
...
#define USB_EVENT_SETINTERFACE          0x00020000  ///< USB Set Interface
...
#define USB_EVENT_SIDCSTOP              0x02000000  ///< USB ABORT Print for SIDC
...
//#NT#2009/09/24#SA4 -begin
#define SICDFSEP1MAXPKTSIZE             64      ///< SIDC FS EP1 max PACKET size
#define SICDHSEP1MAXPKTSIZE             512     ///< SIDC HS EP1 max PACKET size
//#NT#2009/09/24#SA4 -end
