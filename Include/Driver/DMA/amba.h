...
typedef enum
{
    ...
    AMBA_CH_D,              ///< AMBA DMA channel D
    AMBA_NUM,               ///< Total number of AMBA DMA channels
    ENUM_DUMMY4WORD(AMBACH)
} AMBACH;

/**
    Contant symbols for AMBA request command setting.
*/
typedef struct
{
...
/**
    Contant symbols for AMBA request select setting.
*/
typedef enum
{
    AMBA_REQ_SEL_DRAM,      ///< DMA request from DRAM
    AMBA_REQ_SEL_UART_TX,   ///< DMA request from UART TX
    AMBA_REQ_SEL_UART_RX,   ///< DMA request from UART RX
    AMBA_REQ_SEL_UART2_TX,  ///< DMA request from UART2 TX
    AMBA_REQ_SEL_UART2_RX,  ///< DMA request from UART2 RX
    AMBA_REQ_SEL_SPI = 12,  ///< DMA request from SPI
    AMBA_REQ_SEL_I2C,       ///< DMA request from I2C
    AMBA_REQ_SEL_SIF,       ///< DMA request from SIF
    AMBA_REQ_SEL_BMC,       ///< DMA request from BMC
    ENUM_DUMMY4WORD(AMBA_REQ_SEL)
} AMBA_REQ_SEL;


/**
    Contant symbols for AMBA request type setting.
*/
typedef enum
{
...
/**
    Contant symbols for AMBA address increment setting.
*/
typedef enum
{
...
/**
    Contant symbols for AMBA data width setting.
*/
typedef enum
{
...
/**
    Contant symbols for AMBA burst mode setting.
*/
typedef enum
{
...
/**
    @name Contant symbols for AMBA burst size setting.
*/
//@{
...
extern ER amba_checkEnable(AMBACH uiDMAId, BOOL *pEn);
extern ER amba_handleError(AMBACH uiDMAId, BOOL bSynchronous);
