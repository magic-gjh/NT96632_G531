/**
    Header file for Display backward compatibility
...
#define ide_set_dim_convert()                               ide_setDimCvert()
#define ide_set_convert_factor(uiHFT, uiVFT)                ide_setCvertFactor(uiHFT, uiVFT)
...
#define ide_set_osd_blend_op(uiOSDBlendOp)                  ide_setOsdBlendOp(uiOSDBlendOp)
#define ide_set_v1_blend_v2(uiV1BldV2)                      ide_setVideoBlendOp(uiV1BldV2)
...
#define ide_set_sif_startend(uiSIFst, uiSIFed)      ide_setSifStartEnd(uiSIFst, uiSIFed)
...
#define ide_set_video_bgplane()  ide_setVideoBlendOp(IDE_VIDEO_BLEND_VIDEOCK)
...
#define ide_set_video_blend(uiVOpt)  ide_setVideoBlendOp(uiVOpt)
