...
typedef enum
{
    INPUT_WIDTH     = 0x0,   ///< input width, param1: width(in)
    INPUT_HEIGHT    = 0x1,   ///< input height, param1: height(in)
    INPUT_ENC_Q     = 0x2,   ///< input encoding quality, param1: Q(in, 0~100) //2010/01/04 Meg
...
extern UINT32 RawEnc_CalNeedSize(UINT32 maxWid, UINT32 maxHei, RAW_FORMAT_TYPE type);//2011/09/13 Meg
