...
#define MEDIAREC_VRATE_5            5  ///< 5  fps//2012/10/25 Meg
#define MEDIAREC_VRATE_10           10 ///< 10 fps
#define MEDIAREC_VRATE_15           15 ///< 15 fps
#define MEDIAREC_VRATE_20           20 ///< 20 fps
#define MEDIAREC_VRATE_22           22 ///< 22 fps//2013/01/02 Meg
#define MEDIAREC_VRATE_23           23 ///< 23 fps//2013/01/03 Meg
#define MEDIAREC_VRATE_24           24 ///< 24 fps
#define MEDIAREC_VRATE_25           25 ///< 25 fps//2012/12/11 Meg
#define MEDIAREC_VRATE_28           28 ///< 28 fps//2013/01/09 Meg
...
typedef struct
{
    ...
    UINT8               uiAudChannels;   //in:channels, 1 or 2
    UINT8               rev1;
    UINT8               rev2;
    UINT8               rev3;
} MEDIAREC_AACTEST_OBJ;
...
extern ER MediaRec_SetExtendCrash(void);//2012/09/10 Meg
...
extern void     MediaRec_SetYUVtempGet(UINT32 numFrame);//2011/05/11 Meg
...
extern void     MediaAACSetAudio(MEDIAREC_AACTEST_OBJ *param);//2012/02/23 Meg
extern void     MediaAACSetAudioStop(void);//2012/02/23 Meg
extern UINT32   MediaAACGetBSLen(void);//2012/02/23 Meg
