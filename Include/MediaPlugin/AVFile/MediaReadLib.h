...
*/
//@{
#define MEDIA_FILEFORMAT_MOV  0x1
#define MEDIA_FILEFORMAT_AVI  0x2
#define MEDIA_FILEFORMAT_ASF  0x4
//@}

#define MEDIA_PARSEINDEX_MOV 0x1
#define MEDIA_PARSEINDEX_AVI 0x2
...
typedef struct 
{
    ...
    UINT32 avgBPS;  ///< [out] average bytesPerSecond//2010/11/23 Meg Lin
} MEDIA_FIRST_INFO;
...
typedef struct
{
    ...
    UINT8  jpgType;      //out: JPGFormatYUV420
    UINT8  rev;
} MEDIA_PLAY_1ST_INFO;
