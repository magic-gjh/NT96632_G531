...
#define AVI_USERDATA_MAXLEN 128//2011/11/22 Meg adds
...
typedef enum
{
    ...
    MEDIAWRITE_SETINFO_AVIUSERDATA    = 0x9A, ///< avi: param1:user data addr (in), param2: size (in) max:AVI_USERDATA_MAXLEN //2011/11/22 Meg adds
...
typedef struct
{
    ...
    UINT32              uiFrontHDRAddr;     ///< address to make front header //2011/11/02 Meg Lin, fixbug: make nidx wrong
    ...
    UINT8               ucRecQuality;       ///< recording video quality, MEDIAREC_VQUALITY_NORMAL
