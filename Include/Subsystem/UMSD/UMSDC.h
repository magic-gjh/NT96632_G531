...
#define  UMSDC_COMMANDOK        0x0
#define  UMSDC_CLOSED           0x1
#define  UMSDC_USBRESETED       0x2
#define  UMSDC_PHASEERROR       0x3
//#NT#2010/01/25#Klins Chen -begin
#define  UMSDC_READ_BUSY_STATE  0x4
#define  UMSDC_WRITE_BUSY_STATE 0x5
