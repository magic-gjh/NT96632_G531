...
#define IPL_CMD_CHG_SIZE_IME1   0x00000002      ///< change IME path1 size command.
#define IPL_CMD_CHG_SIZE_IME2   0x00000004      ///< change IME path2 size command.
...
typedef struct
{
    ...
    UINT32 uiImeOutWidth1;          ///< ime path1 output width.
    UINT32 uiImeOutHeight1;         ///< ime path1 output height.
    UINT32 uiImeOutWidth2;          ///< ime path2 output width.
