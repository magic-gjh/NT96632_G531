...
#ifndef UIMENUWNDSETUPLCDOFFRES_H
#define UIMENUWNDSETUPLCDOFFRES_H
...
CREATE_LIST_ITEM_DATA(STRID_1MIN32,STRID_1MIN,ICONID_NULL,STATUS_ENABLE) 
CREATE_LIST_ITEM_DATA(STRID_3MIN33,STRID_3MIN,ICONID_NULL,STATUS_ENABLE) 
CREATE_LIST_ITEM_DATA(STRID_5MIN34,STRID_5MIN,ICONID_NULL,STATUS_ENABLE) 
SHOW_MAP_BEGIN(UIMenuWndSetupLcdOff_List_Text)
...
DECLARE_EVENT(UIMenuWndSetupLcdOff_List_Text)
LIST_LIST_BEGIN(UIMenuWndSetupLcdOff_List_Text)
LIST_LIST_ITEM(STRID_OFF31)
LIST_LIST_ITEM(STRID_1MIN32)
LIST_LIST_ITEM(STRID_3MIN33)
LIST_LIST_ITEM(STRID_5MIN34)
LIST_LIST_END

CREATE_LIST_DATA(UIMenuWndSetupLcdOff_List_Text,0,4,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_STOP|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_SKIP|LIST_DRAW_IMAGE,NVTEVT_NULL)

CREATE_LIST_CTRL(UIMenuWndSetupLcdOff_List_Text,UIMenuWndSetupLcdOff_List_Text,0,72,55,287,92)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndSetupLcdOff)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_BODY(Rect3)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndSetupLcdOff)
DECLARE_CTRL_LIST(UIMenuWndSetupLcdOff)
CREATE_CTRL(UIMenuWndSetupLcdOff,UIMenuWndSetupLcdOff,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
