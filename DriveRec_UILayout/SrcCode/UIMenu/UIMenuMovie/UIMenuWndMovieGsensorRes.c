...
#ifndef UIMENUWNDMOVIEGSENSORRES_H
#define UIMENUWNDMOVIEGSENSORRES_H
...
CREATE_MENU_ITEM_DATA(STRID_LOW33,STRID_LOW,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_MED34,STRID_MED,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_HIGH35,STRID_HIGH,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
SHOW_MAP_BEGIN(UIMenuWndMovieGsensor_Menu)
...
DECLARE_EVENT(UIMenuWndMovieGsensor_Menu)
MENU_LIST_BEGIN(UIMenuWndMovieGsensor_Menu)
MENU_LIST_ITEM(STRID_OFF32)
MENU_LIST_ITEM(STRID_LOW33)
MENU_LIST_ITEM(STRID_MED34)
MENU_LIST_ITEM(STRID_HIGH35)
MENU_LIST_END

CREATE_MENU_DATA(UIMenuWndMovieGsensor_Menu,0,4,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_CYCLE|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_NORMAL|MENU_DRAW_IMAGE)

CREATE_MENU_CTRL(UIMenuWndMovieGsensor_Menu,UIMenuWndMovieGsensor_Menu,0,23,3,226,41)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndMovieGsensor_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieGsensor_Panel)
DECLARE_CTRL_LIST(UIMenuWndMovieGsensor_Panel)
CREATE_CTRL(UIMenuWndMovieGsensor_Panel,UIMenuWndMovieGsensor_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
SHOW_MAP_BEGIN(UIMenuWndMovieGsensor)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndMovieGsensor)
DECLARE_CTRL_LIST(UIMenuWndMovieGsensor)
CREATE_CTRL(UIMenuWndMovieGsensor,UIMenuWndMovieGsensor,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
