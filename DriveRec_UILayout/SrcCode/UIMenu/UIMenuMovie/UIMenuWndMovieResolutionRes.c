...
CREATE_MENU_ITEM_DATA(STRID_12M33,STRID_12M,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_IMGSIZE34,STRID_IMGSIZE,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_MODE35,STRID_MODE,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
...
MENU_LIST_ITEM(STRID_12M33)
MENU_LIST_ITEM(STRID_IMGSIZE34)
MENU_LIST_ITEM(STRID_MODE35)
MENU_LIST_END
